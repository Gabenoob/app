...
#define OLED_GPIO_RST_IDX  8
#define OLED_GPIO_DC_IDX   11

#define OLED_SPI_CS_IDX   12

#define OLED_CS_Clr() IoTGpioSetOutputVal(OLED_SPI_CS_IDX,0);
#define OLED_CS_Set() IoTGpioSetOutputVal(OLED_SPI_CS_IDX,1);

#define OLED_DC_Clr()  IoTGpioSetOutputVal(OLED_GPIO_DC_IDX,0);
#define OLED_DC_Set()  IoTGpioSetOutputVal(OLED_GPIO_DC_IDX,1);
 					  
#define OLED_RST_Clr()  IoTGpioSetOutputVal(OLED_GPIO_RST_IDX,0);
#define OLED_RST_Set()  IoTGpioSetOutputVal(OLED_GPIO_RST_IDX,1);


#define FRAME_BUFFER_SIZE 128*64/8  //bytes
static unsigned char OLED_buffer[FRAME_BUFFER_SIZE] = 
{
...
void oled_gpio_io_init(void)
{
    ...
    IoTGpioInit(OLED_GPIO_RST_IDX);
    IoTGpioSetFunc(OLED_GPIO_RST_IDX, 0);
    IoTGpioSetDir(OLED_GPIO_RST_IDX,IOT_GPIO_DIR_OUT);

    IoTGpioInit(OLED_GPIO_DC_IDX);
    IoTGpioSetFunc(OLED_GPIO_DC_IDX, 0);
    IoTGpioSetDir(OLED_GPIO_DC_IDX,IOT_GPIO_DIR_OUT);

    IoTGpioInit(OLED_SPI_CS_IDX);
    IoTGpioSetFunc(OLED_SPI_CS_IDX, 0);
    IoTGpioSetDir(OLED_SPI_CS_IDX,IOT_GPIO_DIR_OUT);
